...
export default function RecomendacionesView({ perfil, recomendaciones }: Props) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-10 text-center">
          <a
            href="/cuestionario"
            className="inline-block px-8 py-4 bg-gray-200 text-gray-700 rounded-xl font-semibold hover:bg-gray-300 transition-all"
          >
